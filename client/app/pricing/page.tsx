  ...
  return (
    <div className="min-h-screen bg-white text-[#1c1c1c]">
      ...
      <div className="relative overflow-hidden pt-20">
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 pt-8 pb-24 sm:px-10 lg:px-12">
          {/* Header Section */}
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-6 flex items-center justify-center">
              <div className="relative inline-flex rounded-full border border-slate-200 bg-white p-1 shadow-sm">
                {/* Sliding background */}
                <div 
                  className={`absolute top-1 bottom-1 rounded-full bg-slate-100 transition-all duration-300 ease-out ${
                    planType === "individual" 
                      ? "left-1 w-[88px]" 
                      : "left-[96px] w-[168px]"
                  }`}
          ...
          >
            ...
            <div 
              ...
              style={{ minHeight: '100%' }}
            >
              {/* Icon + Toggle area - fixed height */}
              <div className="mb-4 flex items-center justify-between h-16">
              ...
              <div className="pricing-card-header flex flex-col h-52">
                ...
                <p className="mt-1 text-sm text-slate-600 invisible">placeholder</p>
                <div className="mt-auto">
                  <Link
                    href="/auth"
                    className="flex h-11 w-full items-center justify-center rounded-lg border border-slate-300 bg-white px-4 text-center text-sm font-semibold text-slate-900 transition-all hover:bg-slate-50 active:scale-[0.98]"
                  >
                    Sử dụng miễn phí
                  </Link>
                </div>
            ...
            >
              ...
              <div className="pricing-card-header flex flex-col h-52">
                ...
                <p className="mt-1 text-sm text-slate-600">
                  {proBillingPeriod === "yearly" ? "thanh toán hàng năm" : "\u00A0"}
                </p>
                <div className="mt-auto">
                  <Link
                    href="/auth"
